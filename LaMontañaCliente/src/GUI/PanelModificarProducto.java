...
public class PanelModificarProducto extends javax.swing.JPanel {
    ...
    public PanelModificarProducto(JDialog dialogParent, IProducto producto) throws RemoteException {
        ...
        nombreTextField.setText(producto.getNombreProducto());
        precioTextField.setText(String.valueOf(producto.getPrecioProducto()));
        descTextField.setText(producto.getDescripProducto());
    ...
    private void aceptarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarButtonActionPerformed
                ...
                try {
                    ...
                    if(respuesta == IProductoController.UPDATE_EXITO){
                        ...
                        JOptionPane.showMessageDialog(this,
                                "ID inexistente"+
                                        "Es probable que el producto haya sido eliminado",
                                "Error",
                                JOptionPane.ERROR_MESSAGE);
                        dialogParent.dispose();
                    }
